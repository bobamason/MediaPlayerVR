...
public class HighlightShader extends BaseShader {
    ...
    public HighlightShader() {
        program = new ShaderProgram(Gdx.files.internal("shaders/highlight_vertex.glsl"), Gdx.files.internal("shaders/highlight_fragment.glsl"));
