...
public class TunnelShader extends BaseShader {
    ...
    public TunnelShader() {
        program = new ShaderProgram(Gdx.files.internal("shaders/tunnel_vertex.glsl"), Gdx.files.internal("shaders/tunnel_fragment.glsl"));
