...
/**
 * Created by Bob on 1/20/2017.
 */
public class MediaCodecVideoRendererNoDrop extends MediaCodecRenderer {
    ...
    private MediaCodecVideoRendererNoDrop.CodecMaxValues codecMaxValues;
     ...
     */
    public MediaCodecVideoRendererNoDrop(Context context, MediaCodecSelector mediaCodecSelector) {
    ...
    private static MediaFormat getMediaFormat(Format format, MediaCodecVideoRendererNoDrop.CodecMaxValues codecMaxValues,
    ...
    /**
     * Returns {@link MediaCodecVideoRenderer.CodecMaxValues} suitable for configuring a codec for {@code format} in a way
     * that will allow possible adaptation to other compatible formats in {@code streamFormats}.
     *
     * @param format        The format for which the codec is being configured.
     * @param streamFormats The possible stream formats.
     * @return Suitable {@link MediaCodecVideoRenderer.CodecMaxValues}.
     */
    private static MediaCodecVideoRendererNoDrop.CodecMaxValues getCodecMaxValues(Format format, Format[] streamFormats) {
        ...
        return new MediaCodecVideoRendererNoDrop.CodecMaxValues(maxWidth, maxHeight, maxInputSize);
    }
    ...
    /**
     * Returns whether an adaptive codec with suitable {@link MediaCodecVideoRenderer.CodecMaxValues} will support adaptation
     * between two {@link Format}s.
     *
     * @param first  The first format.
     * @param second The second format.
     * @return Whether an adaptive codec with suitable {@link MediaCodecVideoRenderer.CodecMaxValues} will support adaptation
     * between two {@link Format}s.
     */
...
//        }
    ...
    public void setDropLateFrames(boolean dropLateFrames) {
        this.dropLateFrames = dropLateFrames;
    }

    public void setDropLateMs(int dropLateMs) {
