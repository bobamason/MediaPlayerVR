...
/**
 * Created by Bob on 1/25/2017.
 */

public class Icons {
    public static final String buttons_pack = "skin/buttons.pack";
    public static final String buttons_image = "buttons.png";
    ...
    public static final String ic_cancel_white_48dp = "ic_cancel_white_48dp";
    public static final String ic_check_circle_white_48dp = "ic_check_circle_white_48dp";
    ...
    public static final String ic_more_horiz_white_48dp = "ic_more_horiz_white_48dp";
    public static final String ic_more_vert_white_48dp = "ic_more_vert_white_48dp";
