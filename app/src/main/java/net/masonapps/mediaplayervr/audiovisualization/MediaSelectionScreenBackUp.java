...
public class MediaSelectionScreenBackUp extends MediaPlayerScreen implements DaydreamControllerInputListener {
    private static final int STATE_NO_LIST = 0;
    private static final int STATE_VIDEO_LIST = 1;
    private static final int STATE_IMAGE_LIST = 2;
    private static final int STATE_ALBUM_LIST = 3;
    private static final int STATE_ARTIST_LIST = 4;
    private static final int STATE_SONG_LIST = 5;
    ...
    public MediaSelectionScreenBackUp(final Context context, VrGame game) {
        super(game);
...
//        stageSongList = new VirtualStage(batch, 720, 420);
        ...
        layoutAlbumList = new AlbumListLayout(context, skin, spriteBatch, executor);
        ...
        layoutArtistList = new ArtistListLayout(context, skin, spriteBatch, executor);
...
//        label3d.draw(spriteBatch);
    ...
    private void switchToPhotosScreen() {
        lastState = STATE_NO_LIST;
        currentState = STATE_IMAGE_LIST;
        stageBack.setVisible(true);
        stageStart.setVisible(false);
        layoutVideoList.setVisible(false);
